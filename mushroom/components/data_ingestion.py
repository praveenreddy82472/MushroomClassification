...
from mushroom.constant.training_pipeline import SCHEMA_FILE_PATH
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = mushroom_data.export_collection_as_dataframe(collection_name=self.data_ingestion_config.collection_name)
